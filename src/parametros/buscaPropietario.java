...
/*
 * buscaPropietario.java
 *
 * Created on 25/03/2015, 11:47:20 PM
 */
package parametros;
 ...
 * @author Betmart
 */
public class buscaPropietario extends javax.swing.JDialog {
    ...
    Connection conex;
    /** Creates new form buscaPropietario */
    propietario obj;
    public buscaPropietario(java.awt.Frame parent, boolean modal, Connection conex, propietario obj) {
        super(parent, modal);
        initComponents();
        this.obj=obj;
        this.conex = conex;
...
public final void buscaProp() {
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT id, nombre FROM mprops WHERE nombre LIKE '%"+jTextField1.getText().toString()+"%' OR "
